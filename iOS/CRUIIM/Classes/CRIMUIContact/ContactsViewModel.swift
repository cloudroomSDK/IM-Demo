...
public class ContactsViewModel {
    ...
    func getGroupApplications() {
        IMController.shared.getGrpReqList { [weak self] (applications: [GroupApplicationInfo]) in
            let ret = applications.compactMap { $0.handleResult == .normal ? $0 : nil }
    ...
    static let NotificationApplicationCountChanged = NSNotification.Name(rawValue: "CRIMNotificationApplicationCountChanged")
