...
class GroupListViewController: UIViewController {
    ...
    private func initView() {
        let searchC: UISearchController = {
            ...
            v.searchBar.placeholder = "群组".innerLocalized()
    ...
    func toConversation(_ groupInfo: GroupInfo) {
        IMController.shared.getConversation(sessionType: .group, sourceId: groupInfo.groupID) { [weak self] (conversation: ConversationInfo?) in
