...
let countDownTimerButtonTitle = "获取验证码"
let countDownTimeInterval = 60
...
class CountDownTimerButton: UIButton {
    ...
    /// 剩余多少秒
    var remainingSeconds: Int = countDownTimeInterval {
    ...
    // 配置UI
    func setupUI() -> Void {
        self.setTitle(" \(countDownTimerButtonTitle) ", for:.normal)
    ...
    @objc func sendButtonClick(_ btn:UIButton) {
        ...
        // 设置重新获取秒数
        self.remainingSeconds = countDownTimeInterval
