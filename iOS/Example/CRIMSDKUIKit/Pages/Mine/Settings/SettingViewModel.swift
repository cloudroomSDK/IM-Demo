...
class SettingViewModel {
    ...
    func toggleNotDisturbStatus() {
        ...
        IMController.shared.setGlobalRecvMsgOpt(op: s) { [weak self] r in
    ...
    func changePassword(password: String, completion: @escaping CompletionHandler) {
        AccountViewModel.changePassword(userID: IMController.shared.userID, password: password, completionHandler: completion)
    }
}
