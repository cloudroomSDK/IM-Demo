...
class CustomPopoverBackgroundView: UIPopoverBackgroundView {
    ...
    private var _arrowDirection: UIPopoverArrowDirection = UIPopoverArrowDirection(rawValue: UIPopoverArrowDirection.up.rawValue | UIPopoverArrowDirection.down.rawValue)
    private let _arrowImageView: UIImageView
    private lazy var backgroundView: UIView = {
        let v = UIView()
        v.backgroundColor = UIColor(hex: 0x555555)
