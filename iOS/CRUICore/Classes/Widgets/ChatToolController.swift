...
public class ChatToolController: UICollectionViewController, UIPopoverPresentationControllerDelegate {
    public let disposeBag = DisposeBag()
    public init(sourceView: UIView, items: [ToolItem]) {
        ...
        collectionView.backgroundColor = StandardUI.color_555555
        collectionView.isScrollEnabled = false
        toolItems = items
        modalPresentationStyle = .popover
        let maxCountPerLine = 5
        ...
        popover?.permittedArrowDirections = UIPopoverArrowDirection(rawValue: UIPopoverArrowDirection.up.rawValue | UIPopoverArrowDirection.down.rawValue)
    ...
    public enum ToolItem: CaseIterable {
        case copy
        case delete
        case forward
        case reply
