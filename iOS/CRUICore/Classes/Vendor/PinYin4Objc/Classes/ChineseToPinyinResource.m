...
- (void)initializeResource {
    ...
    if (dataMap) {
        ...
        NSString *bundlePath = [NSBundle bundleForClass:[ChineseToPinyinResource class]].resourcePath;
        NSString *finalPath = [bundlePath stringByAppendingString:@"/CRIMUIResource.bundle"];
        NSBundle *bundle = [NSBundle bundleWithPath:finalPath];
